...
{      
    ...
    { 
        RTC_Set_Time(15,18,30,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
		RTC_Set_Date(26,2,28,6);		                    //设置日期
...
{ 
    ...
    HAL_NVIC_SetPriority(RTC_Alarm_IRQn,5,0); //抢占优先级5,子优先级0-->适配freertos
...
{ 
    ...
    HAL_NVIC_SetPriority(RTC_WKUP_IRQn,11,0); //抢占优先级5,子优先级0-->适配freertos
